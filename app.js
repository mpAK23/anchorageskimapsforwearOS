...
document.getElementById('recenterBtn').addEventListener('click', () => {
    ...
    if (userMarker) {
        ...
        L.popup()
            .setLatLng(latlng)
            .setContent(`<div style="color: #333; font-family: sans-serif; font-size: 1.2em; padding: 5px; text-align: center;"><strong>Your Location</strong><br>Lat: ${latlng.lat.toFixed(5)}<br>Lon: ${latlng.lng.toFixed(5)}</div>`)
            .openOn(map);
    } else {
