...
function styleTrail(feature) {
    ...
    switch (difficulty) {
        case 'Novice': return { color: '#2ecc71', weight: 5 }; // Bright Green
        case 'Intermediate': return { color: '#3498db', weight: 5 }; // Bright Blue
        case 'Advanced': return { color: '#e74c3c', weight: 5 }; // Bright Red/Orange (easier to see than black)
        default: return { color: '#ecf0f1', weight: 3, dashArray: '5, 10' }; // White dashed for unknown
    }
}
